    ...
    <div style={{ maxWidth: 480, margin: '0 auto', padding: '40px 20px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        <div style={{ background: '#fff', borderRadius: 20, padding: 32, boxShadow: '0 2px 16px rgba(240,160,190,0.12)' }}>
          <h2 style={{ margin: '0 0 6px', fontSize: 16, fontWeight: 700, color: '#4a2d40' }}>
            😊 닉네임 변경
          </h2>
          <p style={{ margin: '0 0 16px', fontSize: 13, color: '#9d7a8a', lineHeight: 1.6 }}>
            닉네임은 사진첩 댓글 등에 표시되는 이름입니다.<br />
            변경은 <strong style={{ color: '#db2777' }}>30일마다 1회</strong>만 가능합니다.
          </p>
          {daysLeft > 0 && (
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: 32, boxShadow: '0 2px 16px rgba(240,160,190,0.12)' }}>
          ...
          <p style={{ margin: '0 0 16px', fontSize: 13, color: '#9d7a8a', lineHeight: 1.6 }}>
            현재 비밀번호 확인 후 변경할 수 있습니다.<br />
            새 비밀번호는 <strong style={{ color: '#db2777' }}>6자 이상</strong>으로 설정해주세요.
          </p>
